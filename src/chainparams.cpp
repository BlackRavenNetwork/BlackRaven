...
/** Standard genesis coinbase P2PK (same as Bitcoin / Ravencoin genesis pattern; output is unspendable). */
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 3200000;  // ~5.0 yrs at 1 min blocks; 5000 * interval * 2 = 32B BLKR max supply
        ...
        // New chain — reset sync assumptions (raise after the network is live).
        ...
        genesis = CreateGenesisBlock(
            "BlackRaven BLKR 2026-04-21 fair launch for asset issuance",
            ...
            5000 * COIN);
        genesis.nHeight = 0;
        genesis.nNonce64 = 282;
        genesis.mix_hash = uint256S("90b04b2cc51ce3c8dcb3ff8dc47676f18c912bf343d55aeaa9cf6e114f770f2b");

        uint256 mainMixHash;
        consensus.hashGenesisBlock = genesis.GetHashFull(mainMixHash);

        assert(mainMixHash == genesis.mix_hash);
        assert(consensus.hashGenesisBlock == uint256S("00023396def928ca141883d7b3af2a5a14658af7e955820a3a6c136f10cd31da"));
        assert(genesis.hashMerkleRoot == uint256S("76e4047740de12de7e0b6592fb81dadcac940785b8f5ac86a5725b149e0142de"));
        ...
        // BIP44 registered coin type for BlackRaven (unlisted — change if you register on github.com/satoshilabs/slips).
        nExtCoinType = 5755;
        ...
        // DGW Activation (keep Raven height so difficulty unit tests and early emission stay consistent)
        ...
        // Keep default Raven activation heights to preserve expected rule ordering in existing tests.
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(
            "BlackRaven testnet BLKR 2026-04-21",
            gGenesisOutputScript,
            1745251300u,
            0u,
            0x207fffff,
        ...
        genesis.nHeight = 0;
        genesis.nNonce64 = 0;
        genesis.mix_hash = uint256S("b4cbd21b96d3f078ce33ef3976bcd90f0b59a0410d5f5fb5e94ed9ca949b4780");

        uint256 testMixHash;
        consensus.hashGenesisBlock = genesis.GetHashFull(testMixHash);

        assert(testMixHash == genesis.mix_hash);
        assert(consensus.hashGenesisBlock == uint256S("2d04b7e8f0abf878d20754fd4d33038ffbc569454261702e963e7a1b5fee8f90"));
        assert(genesis.hashMerkleRoot == uint256S("ea8f1ccd417f46c4ec233af517806ac1f577777ce546dd402dedb4af3a5df365"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.emplace_back("testnet-seed.blackraven.network", false);
...
public:
    CRegTestParams() {
        ...
        pchMessageStart[3] = 0x57; // W (BRGW)
        nDefaultPort = 18444;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(
            "BlackRaven regtest local 2026-04-21",
            gGenesisOutputScript,
            1745251400u,
            0u,
            0x207fffff,
        ...
        genesis.nHeight = 0;
        genesis.nNonce64 = 0;
        genesis.mix_hash = uint256S("639976ee83149ac5cd1a0d37ab151714b9e2ecd651f30e456b4b1da56c476a73");

        uint256 regtestMixHash;
        consensus.hashGenesisBlock = genesis.GetHashFull(regtestMixHash);

        assert(regtestMixHash == genesis.mix_hash);
        assert(consensus.hashGenesisBlock == uint256S("5d78c8f384d51b52471892871437eb4e146d794ca7a71cc4de41810fda372d06"));
        assert(genesis.hashMerkleRoot == uint256S("1ac28919bb8ac6c1188164c68ddebad50efa93616139973090b21e470ae23a0e"));
