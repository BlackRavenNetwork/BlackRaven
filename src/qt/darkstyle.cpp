...
{
  /* BlackRaven dark theme — slate base, gold highlights */
  palette.setColor(QPalette::Window, QColor(22, 28, 38));
...
*/
  ...
  palette.setColor(QPalette::Dark, QColor(15, 23, 42));
  palette.setColor(QPalette::Shadow, QColor(2, 6, 23));
  palette.setColor(QPalette::Button, QColor(30, 41, 59));
  palette.setColor(QPalette::ButtonText, Qt::white);
  palette.setColor(QPalette::Disabled, QPalette::ButtonText, QColor(127, 127, 127));
  palette.setColor(QPalette::BrightText, Qt::red);
  const QColor accentGold(201, 162, 39);
  palette.setColor(QPalette::Link, accentGold);
  palette.setColor(QPalette::Highlight, accentGold);
