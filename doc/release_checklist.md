...
**Post Release :**
  ...
  1. Update blackraven.network with correct popup version
  
  2. Update blackraven.network with correct release download urls for each platform (Windows, Linux, Mac)
