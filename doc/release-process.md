...
* Update translations see [translation_process.md](https://github.com/BlackRavenNetwork/BlackRaven/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/BlackRavenNetwork/BlackRaven/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
### First time / New builders
    ...
    git clone https://github.com/BlackRavenNetwork/BlackRaven.git
...
- Update blackraven.network version
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/BlackRavenNetwork/BlackRaven/releases/new) with a link to the archived release notes.
